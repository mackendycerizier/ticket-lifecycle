...
<h2>Demonstration: Ticket Lifecycle & SLAs</h2>
...
<h4>1- Ticket Lifecycle Stages: From Creation to Completion</h4>

<p>We will walk through the different stages a ticket goes through once it is created until it is resolved and closed.</p>
<ul>
  <li>
<p><strong>Intake:</strong> The initial step where a ticket is created by the user or an agent.</p>
</li>
  <li>
<p><strong>Assignment and Communication:</strong> The ticket is assigned to a department or agent, and communication with the user begins.</p></li>
<li>
<p><strong>Working the Issue:</strong> The assigned agent works on resolving the issue or provides updates.</p></li>
<li>
<p><strong>Resolution:</strong> The problem is resolved, and the ticket is closed after verifying the solution with the user.</p></li>
</ul>
<h4>2- Prioritizing Tickets Based on Severity and SLAs (Service Level Agreements)</h4>
...
<ul>
  <li>
<p><strong>Sev-A (1 hour, 24/7):</strong> This is the highest priority for critical issues, such as when the entire mobile or online banking system is down. The SLA requires a resolution within 1 hour, and the ticket is immediately escalated to the SysAdmins team for 24/7 handling.</p></li>

<li><p><strong>Sev-B (4 hours, 24/7):</strong> These are important but less urgent issues, like the accounting department needing an Adobe upgrade. The SLA ensures a 4-hour response and resolution time, still available around the clock.</p></li>

<li><p><strong>Sev-B/C (2 hours, business hours):</strong> This represents lower-priority issues, such as the CFO's laptop running slowly. The SLA guarantees a 2-hour resolution, but only within standard business hours.</p></li>
</ul>
...
<h4>3- Triaging Tickets: Identifying or Escalating Issues</h4>
...
<h4>4- Solving Problems and Closing Tickets</h4>
